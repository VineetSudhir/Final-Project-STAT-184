...
(A) .Rmd Line numbers where at least two different data sources are imported:  23-48 


(B) .Rmd Line numbers for inspecting data intake:  52-86
...
(A) .Rmd Line number(s) for general data wrangling: 110-117, 119-130, 132-140, 


(B) .Rmd Line number(s) for a join operation: 142-156
...
(E) .Rmd Line number(s) for use of reduction and/or transformation functions: 88-107


(F) .Rmd Line number(s) for use of user-defined functions: 122-127


(G) .Rmd Line number(s) for use of loops and/or control flow: 159-172, 173-186,  
...
(A) .Rmd Line number(s) for use of mulitple different geoms:  199-204, 216-221

(B) .Rmd Line number(s) for use of multiple aesthetics:  199-203, 216-220

(C) .Rmd Line number(s) for use of layered graphics:  199-205, 216-222
